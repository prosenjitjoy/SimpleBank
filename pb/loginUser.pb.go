...
const file_loginUser_proto_rawDesc = "" +
	"\n" +
	"\x0floginUser.proto\x12\x02pb\x1a\n" +
	...
	"\x18refresh_token_expires_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x15refreshTokenExpiresAtB\tZ\amain/pbb\x06proto3"

var (
	file_loginUser_proto_rawDescOnce sync.Once
	file_loginUser_proto_rawDescData []byte
)

func file_loginUser_proto_rawDescGZIP() []byte {
	file_loginUser_proto_rawDescOnce.Do(func() {
		file_loginUser_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_loginUser_proto_rawDesc), len(file_loginUser_proto_rawDesc)))
	})
	return file_loginUser_proto_rawDescData
}

var file_loginUser_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_loginUser_proto_goTypes = []any{
...
func file_loginUser_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_loginUser_proto_rawDesc), len(file_loginUser_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
