...
const file_createUser_proto_rawDesc = "" +
	"\n" +
	"\x10createUser.proto\x12\x02pb\x1a\n" +
	"user.proto\"~\n" +
...
var (
	...
	file_createUser_proto_rawDescData []byte
)

func file_createUser_proto_rawDescGZIP() []byte {
	file_createUser_proto_rawDescOnce.Do(func() {
		file_createUser_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_createUser_proto_rawDesc), len(file_createUser_proto_rawDesc)))
	})
	return file_createUser_proto_rawDescData
}

var file_createUser_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_createUser_proto_goTypes = []any{
...
func file_createUser_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_createUser_proto_rawDesc), len(file_createUser_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
